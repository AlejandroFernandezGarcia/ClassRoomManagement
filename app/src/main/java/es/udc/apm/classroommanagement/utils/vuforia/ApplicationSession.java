...
public class ApplicationSession implements UpdateCallbackInterface
{
    ...
    public void initAR(Activity activity, int screenOrientation)
    {
        ...
        if (mInitVuforiaTask != null)
        {
            ...
            vuforiaException = new ApplicationException(
                ...
                logMessage);
            logError(this, vuforiaException);
        }
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, "");
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            if (result)
            {
                logInfo(this, "InitVuforiaTask.onPostExecute: Vuforia "
            ...
            } else
            {
                ...
                // Log error:
                logError(this, "InitVuforiaTask.onPostExecute: " + logMessage
                    + " Exiting.");
    ...
    private class LoadTrackerTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            logInfo(this, "LoadTrackerTask.onPostExecute: execution "
